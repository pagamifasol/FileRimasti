...
geometry create shape shell  &
   ...
   file_name = "mdids://SCG007C_2WD4WD_bck6Ott/shell_graphics.tbl/RaceCar_RT_ges_chassis.shl"  &
   wireframe_only = no
geometry attributes  &
...
defaults model  &
   part_name = .RaceCar.whl_front_wheel
geometry create shape shell  &
   file_name = "mdids://SCG007C_2WD4WD_bck6Ott/shell_graphics.tbl/RaceCar_RT_whl_front_rim.shl"  &
   shell_name = rim  &
   reference_marker = .RaceCar.whl_front_wheel.tire_i  &
   wireframe_only = no
geometry create shape shell  &
   file_name = "mdids://SCG007C_2WD4WD_bck6Ott/shell_graphics.tbl/RaceCar_RT_whl_front_tire.shl"  &
   shell_name = tire  &
   reference_marker = .RaceCar.whl_front_wheel.tire_i  &
   wireframe_only = no
!
defaults model  &
   part_name = .RaceCar.whr_front_wheel
geometry create shape shell  &
   file_name = "mdids://SCG007C_2WD4WD_bck6Ott/shell_graphics.tbl/RaceCar_RT_whr_front_rim.shl"  &
   shell_name = rim  &
   reference_marker = .RaceCar.whr_front_wheel.tire_i  &
   wireframe_only = no
geometry create shape shell  &
   file_name = "mdids://SCG007C_2WD4WD_bck6Ott/shell_graphics.tbl/RaceCar_RT_whr_front_tire.shl"  &
   shell_name = tire  &
   reference_marker = .RaceCar.whr_front_wheel.tire_i  &
   wireframe_only = no
!
defaults model  &
   part_name = .RaceCar.whl_rear_wheel
geometry create shape shell  &
   file_name = "mdids://SCG007C_2WD4WD_bck6Ott/shell_graphics.tbl/RaceCar_RT_whl_rear_rim.shl"  &
   shell_name = rim  &
   reference_marker = .RaceCar.whl_rear_wheel.tire_i  &
   wireframe_only = no
geometry create shape shell  &
   file_name = "mdids://SCG007C_2WD4WD_bck6Ott/shell_graphics.tbl/RaceCar_RT_whl_rear_tire.shl"  &
   shell_name = tire  &
   reference_marker = .RaceCar.whl_rear_wheel.tire_i  &
   wireframe_only = no
!
defaults model  &
   part_name = .RaceCar.whr_rear_wheel
geometry create shape shell  &
   file_name = "mdids://SCG007C_2WD4WD_bck6Ott/shell_graphics.tbl/RaceCar_RT_whr_rear_rim.shl"  &
   shell_name = rim  &
   reference_marker = .RaceCar.whr_rear_wheel.tire_i  &
   wireframe_only = no
geometry create shape shell  &
   file_name = "mdids://SCG007C_2WD4WD_bck6Ott/shell_graphics.tbl/RaceCar_RT_whr_rear_tire.shl"  &
   shell_name = tire  &
   reference_marker = .RaceCar.whr_rear_wheel.tire_i  &
   wireframe_only = no
!
